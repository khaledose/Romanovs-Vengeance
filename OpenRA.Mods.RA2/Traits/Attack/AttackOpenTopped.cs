...
namespace OpenRA.Mods.RA2.Traits
{
	...
	public class AttackOpenToppedInfo : AttackFollowInfo, IRulesetLoaded
	{
		...
		[Desc("The delay between every random muzzle sequence rendered.")]
		public readonly int MuzzleActivationDelay = 5;
	...
	public class AttackOpenTopped : AttackFollow, INotifyGarrisonerEntered, INotifyGarrisonerExited, IRender, INotifyPassengerEntered, INotifyPassengerExited
	{
			...
			: base(self, info)
		{
			...
			tick = Info.MuzzleActivationDelay;
		}
		...
		public void RenderMuzzle(Actor self, Armament a)
		{
			...
			paxPos[a.Actor].SetCenterPosition(a.Actor, self.CenterPosition + PortOffset(self, port));
		...
		protected override void Tick(Actor self)
		{
			...
			if (Info.RandomMuzzleActivations && firing && RequestedTarget.Type != Target.Invalid.Type && tick-- <= 0)
			{
