...
WorldLoaded = function()
	...
	local dog1 = Actor.Create("sdog", true, { Owner = soviets, Location = DoggoPatrolPath[1], SubCell = 1 })
	local dog2 = Actor.Create("sdog", true, { Owner = soviets, Location = DoggoPatrolPath[1], SubCell = 2 })
