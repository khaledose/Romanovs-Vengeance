...
WorldLoaded = function()
	...
	local dog1 = Actor.Create("adog", true, { Owner = allies, Location = DoggoPatrol1[1], SubCell = 1 })
	local dog2 = Actor.Create("adog", true, { Owner = allies, Location = DoggoPatrol1[2], SubCell = 2 })
	local dog3 = Actor.Create("adog", true, { Owner = allies, Location = DoggoPatrol2[1], SubCell = 1 })
	local dog4 = Actor.Create("adog", true, { Owner = allies, Location = DoggoPatrol2[2], SubCell = 2 })
