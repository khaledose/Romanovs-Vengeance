...
SetUpPatrols = function()
	ADog1 = Actor.Create("adog", true, { Owner = allies, Location = PatrolWPs1[1] })
	ADog2 = Actor.Create("adog", true, { Owner = allies, Location = PatrolWPs1[1] })
	ADog3 = Actor.Create("adog", true, { Owner = allies, Location = PatrolWPs2[1] })
	ADog4 = Actor.Create("adog", true, { Owner = allies, Location = PatrolWPs2[1] })
	AGI1  = Actor.Create("e1" , true, { Owner = allies, Location = PatrolWPs3[1] })
	AGI2  = Actor.Create("e1" , true, { Owner = allies, Location = PatrolWPs4[1] })
	ADog5 = Actor.Create("adog", true, { Owner = allies, Location = PatrolWPs3[1] })
	ADog6 = Actor.Create("adog", true, { Owner = allies, Location = PatrolWPs4[1] })
