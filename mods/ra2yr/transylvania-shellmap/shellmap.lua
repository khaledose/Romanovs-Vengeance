...
IFVTypes = {"fv.virus", "fv.init", "fv.ivan", "fv.tesla", "fv.yuri"}
...
WorldLoaded = function()
	...
	local lazarus1 = Actor.Create("ltnk", true, { Owner = psicorps, Location = LazarusPatrol1[1] })
	local lazarus2 = Actor.Create("ltnk", true, { Owner = psicorps, Location = LazarusPatrol2[1] })
	...
	local sdoggo1 = Actor.Create("sdog", true, { Owner = soviets, Location = SDoggoPatrol1[1] })
	local sdoggo2 = Actor.Create("sdog", true, { Owner = soviets, Location = SDoggoPatrol1[1] })
